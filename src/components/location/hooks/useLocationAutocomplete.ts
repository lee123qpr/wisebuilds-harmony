...
export const useLocationAutocomplete = (formField: any, fieldName: string = 'location') => {
      ...
      const listener = window.google.maps.event.addListener(
        ...
        () => {
          ...
          if (place && place.formatted_address) {
            ...
            formField.setValue(fieldName, place.formatted_address, { 
              shouldValidate: true,
              shouldDirty: true,
              shouldTouch: true
            });
            ...
            formField.setValue(fieldName, place.name, { 
              shouldValidate: true,
              shouldDirty: true,
              shouldTouch: true
            });
  ...
  }, [isLoaded, formField, fieldName, toast, autocompleteInstance]);
