              ...
              <CardContent className="space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">{formatRole(project.role)}</p>
                  </div>
                  <div>
                    <h4 className="font-medium">Budget</h4>
                    <p className="text-muted-foreground">{formatBudget(project.budget)}</p>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">{project.work_type}</p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <h4 className="font-medium">Requires Insurance</h4>
                    <p className="text-muted-foreground">{project.requires_insurance ? 'Yes' : 'No'}</p>
                  </div>
                  <div>
                    <h4 className="font-medium">Requires Equipment</h4>
                    <p className="text-muted-foreground">{project.requires_equipment ? 'Yes' : 'No'}</p>
                  </div>
                  <div>
                    <h4 className="font-medium">Requires Site Visits</h4>
                    <p className="text-muted-foreground">{project.requires_site_visits ? 'Yes' : 'No'}</p>
                  </div>
                </div>
              </CardContent>
            </Card>
          ...
          <div className="space-y-6">
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  <h4 className="text-sm font-medium">Hiring Status</h4>
                  <div className="mt-1">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">{project.applications} applications</p>
                </div>
              </CardContent>
            </Card>
            ...
            {project.applications > 0 && (
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>{project.applications} applications received</CardDescription>
                </CardHeader>
                <CardContent>
                  <Button 
                    className="w-full"
