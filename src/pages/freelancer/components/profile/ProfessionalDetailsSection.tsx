...
const ProfessionalDetailsSection: React.FC<ProfessionalDetailsSectionProps> = ({
  ...
  return <div className="bg-card rounded-lg p-5 shadow-sm border border-border/40">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
        {profile.hourly_rate && <div className="bg-muted/50 rounded-md p-3 flex items-start gap-3">
            <PoundSterling className="h-5 w-5 mt-0.5 text-primary/80" />
            <div>
              <p className="text-sm font-medium text-muted-foreground">Hourly Rate (Guide)</p>
              <p className="font-medium text-foreground">£{profile.hourly_rate}</p>
            </div>
          </div>}
        
        {profile.day_rate && <div className="bg-muted/50 rounded-md p-3 flex items-start gap-3">
            <PoundSterling className="h-5 w-5 mt-0.5 text-primary/80" />
            <div>
        ...
        {profile.availability && <div className="bg-muted/50 rounded-md p-3 flex items-start gap-3">
        ...
        {profile.experience && <div className="bg-muted/50 rounded-md p-3 flex items-start gap-3">
