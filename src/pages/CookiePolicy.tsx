    ...
    <MainLayout>
      <div className="container mx-auto py-8 sm:py-12 px-4">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-2xl sm:text-3xl font-bold mb-6 sm:mb-8">Cookie Policy</h1>
          ...
          <div className="prose prose-sm sm:prose-base lg:prose-lg max-w-none">
            ...
            <h2 className="text-xl sm:text-2xl font-semibold mt-6 sm:mt-8 mb-3 sm:mb-4">How we use cookies</h2>
            <p>
              We use cookies for a variety of reasons, including to:
            </p>
            <ul className="list-disc pl-4 sm:pl-6 space-y-1 sm:space-y-2 mt-3 sm:mt-4">
            ...
            <h3 className="text-lg sm:text-xl font-semibold mt-5 sm:mt-6 mb-2 sm:mb-3">Necessary cookies</h3>
            <p>
            ...
            <h3 className="text-lg sm:text-xl font-semibold mt-5 sm:mt-6 mb-2 sm:mb-3">Functional cookies</h3>
            <p>
            ...
            <h3 className="text-lg sm:text-xl font-semibold mt-5 sm:mt-6 mb-2 sm:mb-3">Analytical cookies</h3>
            <p>
            ...
            <h3 className="text-lg sm:text-xl font-semibold mt-5 sm:mt-6 mb-2 sm:mb-3">Marketing cookies</h3>
            <p>
            ...
            <h2 className="text-xl sm:text-2xl font-semibold mt-6 sm:mt-8 mb-3 sm:mb-4">Your cookie choices and how to opt-out</h2>
            <p>
            ...
            <h2 className="text-xl sm:text-2xl font-semibold mt-6 sm:mt-8 mb-3 sm:mb-4">Changes to our Cookie Policy</h2>
            <p>
